...
class Controlled_Chaos_Bookmarks {
	...
	public function __construct() {
		...
		add_action( 'controlled_chaos_bookmarks', [ $this, 'bookmarks' ] );
	...
	public function bookmarks() {
		...
		$bookmarks = apply_filters( 'cct_bookmarks', $output );
		return $bookmarks;
...
$controlled_chaos_bookmarks = new Controlled_Chaos_Bookmarks;