        ...
        <article class="hentry" id="post-<?php the_ID(); ?>" role="article">
            ...
            <?php if ( '' !== get_the_post_thumbnail() ) : ?>
                <div class="post-thumbnail">
                    ...
                    $size = apply_filters( 'cctheme_archive_thumbnail_size', 'medium' );
                    $args = apply_filters( 'cctheme_archive_thumbnail_args', [
                        'class' => 'alignnone'
                    ] );
                ...
                <?php if ( 'excerpt' == cctheme_sanitize_archive_content_format( get_theme_mod( 'cctheme_archive_content_format' ) ) ) {
                    the_excerpt();
                } else {
                    the_content();
                } ?>
