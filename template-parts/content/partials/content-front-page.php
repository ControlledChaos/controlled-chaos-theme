...
<div id="content" class="site-content global-wrapper page-wrapper">
    <?php do_action( 'cctheme_before_main' ); ?>
        ...
        <article class="hentry" id="post-<?php the_ID(); ?>" role="article">
            ...
            <div class="entry-content" itemprop="articleBody">
                ...
                <div class="post-thumbnail">
                    <?php
                    $size = apply_filters( 'cctheme_front_page_thumbnail_size', 'large' );
                    $args = apply_filters( 'cctheme_front_page_thumbnail_args', [
                        'class' => 'alignnone'
                    ] );
    ...
    <?php do_action( 'cctheme_content_aside' ); ?>
</div><!-- site-content -->